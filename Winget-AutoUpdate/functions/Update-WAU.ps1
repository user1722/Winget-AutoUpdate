...
function Update-WAU
{
   $OnClickAction = 'https://github.com/user1722/Winget-AutoUpdate/releases'
   ...
   try
   {
      ...
      $null = (Invoke-RestMethod -Uri ('https://github.com/user1722/Winget-AutoUpdate/releases/download/v{0}/WAU.zip' -f ($WAUAvailableVersion)) -OutFile $ZipFile)
