...
$App = @("Microsoft Visual C++ 2008 Redistributabl*","Microsoft Visual C++ 2008 Redistributabl*","Microsoft Visual C++ 2008 Redistributabl*")
...
$AppID = @("Microsoft.VCRedist.2008.x64", "Microsoft.VCRedist.2008.x86")
