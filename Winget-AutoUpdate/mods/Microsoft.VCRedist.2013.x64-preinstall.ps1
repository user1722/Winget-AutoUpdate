...
$App = @("Microsoft Visual C++ 2013 Redistributabl*","Microsoft Visual C++ 2013 Redistributabl*","Microsoft Visual C++ 2013 Redistributabl*")
...
$AppID = @("Microsoft.VCRedist.2013.x64", "Microsoft.VCRedist.2013.x86")
